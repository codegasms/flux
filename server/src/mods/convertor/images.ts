 ...
 */
export async function gifToPng(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
 ...
 */
export async function pngToGif(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
  return new Promise(async (resolve, reject) => {
    ...
    const proc1 = spawn('unzip', [sourceFile, '-d', tempDir], {
      stdio: 'pipe',
    });
...
export async function showMetadata(
  ...
  return new Promise(async (resolve, reject) => {
    const proc = spawn('exiftool', [sourceFile, '>', destinationFile], {
      stdio: 'pipe',
    });
