...
export async function textToPdf(
  ...
  return new Promise(async (resolve, reject) => {
    ...
    const proc = spawn('pandoc', [sourceFile, '-o', destinationFile], {
      cwd,
      stdio: 'pipe',
    });
...
export async function pdfToImage(
  ...
  return new Promise(async (resolve, reject) => {
    ...
    const proc2 = spawn('zip', ['-r', destinationFile, tempDir], {
      stdio: 'pipe',
    });
 ...
 */
export async function xlsToPdf(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
 ...
 */
export async function xlsToCsv(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
 ...
 */
export async function csvToXls(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
 ...
 */
export async function xlsToXml(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
 ...
 */
export async function xmlToXls(
  sourceFile: string,
  destinationFile: string,
  _args?: any,
): Promise<void> {
